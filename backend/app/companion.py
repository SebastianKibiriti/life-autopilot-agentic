...
def create_fitness_suggestion(student_id, profile, campus_name="Campus Cycling Track"):
    ...
    return CompanionSuggestion(
        ...
        main_recommendation=f"Try a 35-minute {preferred} session at {campus_name} after your next nutrition class.",
        alternatives=["A 25-minute campus run", "A 30-minute walking recovery route"],
        rationale="Your recent calendar pattern shows repeated fitness events, and your saved preferences favor outdoor activity.",
        estimated_duration_minutes=35, location=campus_name,
        preparation=["Bring water", "Check weather before leaving"],
        uncertainty="Availability and weather were not verified.",
        follow_up_answers={"why": "This matches your recent fitness focus and saved outdoor-activity preference.", "duration": "The main option takes about 35 minutes.", "alternatives": "You can choose a 25-minute run or a 30-minute recovery walk."},
